      ...
      <main className="flex-grow">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div
              className="marble-bg p-8 rounded-lg text-white"
              style={{ backgroundColor: "#800020" }}
            >
              <AnimatedSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <AnimatedSection delay={0.4} direction="up">
              <div className="flex flex-col items-center text-center p-6 border border-border-color rounded-lg hover:border-primary transition-colors">
                ...
                <p className="text-gray-600 text-sm">
                  Detect and prevent fraudulent claims with advanced AI
                  algorithms
                </p>
              </div>
            </AnimatedSection>
              ...
              <div className="relative p-6 border border-border-color rounded-lg">
                <blockquote className="text-gray-700">
                  <p className="mb-4 text-lg italic">
                    "Vistora has transformed our claims processing workflow.
                    We've reduced processing time by 60% and improved accuracy
                    significantly."
                  </p>
              ...
              <AnimatedSection delay={0.2} direction="right">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    Our platform provides real-time visibility into the status
                    of every claim. Healthcare providers and patients can track
                    claims from submission to payment, with transparent updates
                    at each stage of the process.
                  </p>
                  <p className="text-gray-600 mb-4">
                    The intuitive dashboard displays key metrics like processing
                    time, approval rates, and pending actions, allowing
                    administrators to identify bottlenecks and optimize
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              >
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    Vistora leverages blockchain-based smart contracts to
                    automate claim adjudication based on predefined rules and
                    policies. This eliminates manual review for standard claims,
                    dramatically reducing processing time and human error.
                  </p>
                  <p className="text-gray-600 mb-4">
                    Our system automatically validates claims against policy
                    terms, checks for duplicate submissions, and verifies
                    provider credentials, ensuring compliance while accelerating
                    payments.
                  </p>
                  <div className="flex items-center text-primary font-medium">
                    <a href="#" className="flex items-center hover:underline">
              ...
              <AnimatedSection delay={0.2} direction="right">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    comprehensive analytics dashboard. Visualize trends,
                    identify patterns, and make data-driven decisions to
                    optimize your healthcare operations.
                  </p>
                  <p className="text-gray-600 mb-4">
                    Our platform provides customizable reports on key metrics
                    such as claim volume, approval rates, processing times, and
                    denial reasons. Set up automated alerts for unusual patterns
                    that might indicate fraud or system issues.
                  </p>
                  <div className="flex items-center text-primary font-medium">
                    <a href="#" className="flex items-center hover:underline">
