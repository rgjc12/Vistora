...
const Notifications = () => {
  ...
  const loadNotifications = () => {
    try {
      ...
      const storedNotifications = JSON.parse(localStorage.getItem("vistora_notifications") || "[]")
  ...
  const handleMarkAsRead = (notificationId) => {
    ...
    localStorage.setItem("vistora_notifications", JSON.stringify(updatedNotifications))
    ...
    <div className="space-y-6 font-['Manrope',_sans-serif]">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-1">Stay updated on claims, tasks, and system alerts</p>
        </div>
        <div className="flex space-x-3">
          ...
          <button
            ...
            className="px-4 py-2 border border-slate-300 text-slate-700 rounded-lg hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-semibold"
          >
            Clear All
          </button>
        </div>
      ...
      <div className="border-b border-slate-200">
        <div className="flex space-x-8">
          ...
          <button
            ...
            className={`py-4 px-1 relative font-medium text-sm ${
              activeTab === "unread" ? "text-blue-600" : "text-slate-500 hover:text-slate-700"
            }`}
          >
            Unread
            ...
            {activeTab === "unread" && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600"></span>}
          </button>
          <button
            onClick={() => setActiveTab("claim")}
            className={`py-4 px-1 relative font-medium text-sm ${
              activeTab === "claim" ? "text-blue-600" : "text-slate-500 hover:text-slate-700"
            }`}
          >
            Claims
            ...
            {activeTab === "claim" && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600"></span>}
          </button>
          <button
            onClick={() => setActiveTab("task")}
            className={`py-4 px-1 relative font-medium text-sm ${
              activeTab === "task" ? "text-blue-600" : "text-slate-500 hover:text-slate-700"
            }`}
          >
            Tasks
            ...
            {activeTab === "task" && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600"></span>}
          </button>
          <button
          ...
          >
            ...
            {activeTab === "system" && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600"></span>}
          </button>
        </div>
      </div>
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <h3 className={`font-bold ${notification.isRead ? "text-slate-900" : "text-blue-900"}`}>
                      {notification.title}
                    </h3>
