      ...
      <div className="w-full max-w-md px-6 text-center space-y-6">
        ...
        <div className="rounded-md border border-dashed border-gray-300 p-6 bg-gray-50">
          <p className="text-sm text-gray-600">
            We have sent a verification link to your email. Please check your inbox to{" "}
            <span className="text-black font-medium">finalize your registration</span>.
          </p>
        </div>

        <FormButtonSecondary buttonText="Resend Email" action={handleResendEmail} />
