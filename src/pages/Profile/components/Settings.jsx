      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => dispatch(updateProfile({ organization: e.target.value }))}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => dispatch(updateProfile({ settings: e.target.value }))}
                />
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Notifications are on</label>
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input 
                      ...
                      onChange={(e) => dispatch(updateNotificationSetting({ setting: 'email', value: e.target.checked }))}
                    />
                  ...
                  <label className="flex items-center">
                    <input 
                      ...
                      onChange={(e) => dispatch(updateNotificationSetting({ setting: 'sms', value: e.target.checked }))}
                    />
                  ...
                  <label className="flex items-center">
                    <input 
                      ...
                      onChange={(e) => dispatch(updateNotificationSetting({ setting: 'pushOnly', value: e.target.checked }))}
                    />
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input 
                      ...
                      onChange={() => dispatch(updateNotificationFrequency('immediately'))}
                    />
                  ...
                  <label className="flex items-center">
                    <input 
                      ...
                      onChange={() => dispatch(updateNotificationFrequency('daily'))}
                    />
                  ...
                  <label className="flex items-center">
                    <input 
                      ...
                      onChange={() => dispatch(updateNotificationFrequency('hourly'))}
                    />
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Connected External</label>
                <div className="flex items-center space-x-2">
                  <input
                    type="text"
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value={settings.integration.connectedExternal}
                    onChange={(e) => dispatch(updateIntegration({ connectedExternal: e.target.value }))}
                  />
                  <button className="px-3 py-2 text-sm text-blue-600 hover:text-blue-800">Manage API Access</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => dispatch(updateSecurityField({ field: 'newPassword', value: e.target.value }))}
                />
                <input
                  type="password"
                  ...
                  onChange={(e) => dispatch(updateSecurityField({ field: 'confirmPassword', value: e.target.value }))}
                />
                <button 
